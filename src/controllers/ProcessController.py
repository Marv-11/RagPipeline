...
class ProcessController(BaseController):
    ...
    def get_file_loader(self, file_id: str):
        ...
        # Determine the file type based on the file extension and return the appropriate loader
        file_extension = self.get_file_extention(file_id=file_id)
        # Construct the full file path using the project path and file ID
        file_path = os.path.join(self.project_path, file_id)

        # Use the file extension to determine which loader to use
